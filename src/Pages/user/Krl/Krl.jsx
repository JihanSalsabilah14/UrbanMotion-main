      ...
      <section className="KRL">
        <div className="containerKrl">
          <div className="contentKrl">
            ...
            <h1>Commuter Line</h1>
            <p>
              Tempat pemberhentian bagi kereta listrik, dilengkapi dengan
              fasilitas akses masuk, area tunggu, dan layanan tiket untuk
              mendukung mobilitas penumpang secara efisien di kawasan perkotaan
              padat.
            </p>
