      ...
      <section className="MRT">
        <div className="containerMrt">
          <div className="contentMrt">
            ...
            <h1>Commuter Line</h1>
            <p>
              Tempat pemberhentian khusus untuk layanan kereta Mass Rapid
              Transit (MRT) yang menghubungkan wilayah di Jakarta melalui jalur
              cepat dan efisien. tempat pemberhentian khusus untuk layanan
              kereta Mass Rapid Transit (MRT) yang menghubungkan wilayah di
              Jakarta melalui jalur cepat dan efisien.
            </p>
      ...
      <section className="LRT">
        <div className="containerLrt">
          <div className="contentLrt">
            ...
            <h1>Commuter Line</h1>
            <p>
              Tempat pemberhentian kereta Light Rail Transit (LRT) yang melayani
              rute singkat dengan jalur layang, umumnya di Jakarta dan
              sekitarnya. Setiap stasiun LRT dilengkapi fasilitas modern seperti
              area tunggu tertutup, akses lift, dan gerbang tiket otomatis,
              memberikan kenyamanan bagi penumpang di kawasan perkotaan.
            </p>
            <a href="#" className="button">
              Lihat Rute
            </a>
