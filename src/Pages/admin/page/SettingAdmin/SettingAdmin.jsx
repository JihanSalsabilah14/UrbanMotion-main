        ...
        <div className="flex flex-wrap lg:flex-nowrap gap-8">
          ...
          <div className="lg:w-1/3">
            <div className="bg-primary-10 shadow-md rounded-lg p-6 text-center">
              ...
              />
              <h2 className="text-lg text-secondary-30 font-semibold">
                Profi Saya
              </h2>
              <h4 className="text-lg text-secondary-30 font-semibold">
                Budiman
              </h4>
              ...
              <div>
                ...
                <div className="mb-4">
                  ...
                  <input
                    type="text"
                    id="alamat"
                    defaultValue="Jalan M.H Thamrin"
                    className="form-input w-full"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mb-4">
                  ...
                  <input
                    type="email"
                    id="email"
                    defaultValue="budiman@gmail.com"
                    className="form-input w-full"
                  />
                </div>
                <div className="mb-4">
                  ...
                  <div className="flex items-center">
                    <span className="inline-block bg-gray-200 px-3 py-2 rounded-l">
                      +62
                    </span>
                    <input
                      type="text"
